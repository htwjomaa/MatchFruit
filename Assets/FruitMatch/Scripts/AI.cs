...
// #if UNITY_EDITOR
            ...
            {
                if (TipItem && !TipItem.destroying && TipItem.gameObject.activeSelf && !LevelManager.THIS.findMatchesStarted && !LevelManager.THIS.DragBlocked) TipItem.SwitchDirection
                (-THIS.vDirection);
                yield return new WaitForSeconds(1);
...
// #endif
        ...
        {
            return sq.field.GetSquare(sq.GetPosition() + vector2 );
        }
