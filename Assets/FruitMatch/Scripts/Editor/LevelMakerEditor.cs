...
namespace FruitMatch.Scripts.Editor
{
    ...
    public class LevelMakerEditor : EditorWindow
    {
        ...
        [MenuItem("FruitMatch/Level editor")]
        ...
        [MenuItem("FruitMatch/Settings/Game settings")]
        ...
        [MenuItem("FruitMatch/Settings/In-app settings")]
        ...
        [MenuItem("FruitMatch/Settings/Ads settings")]
        ...
        private void OnFocus()
        {
            ...
            targetEditorScriptable = AssetDatabase.LoadAssetAtPath<TargetEditorScriptable>("Assets/FruitMatch/Resources/Levels/TargetEditorScriptable.asset");
            ...
            arrows[0] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitMatch/Textures_png/EditorSprites/arrow.png",typeof(Texture));
            arrows[1] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitMatch/Textures_png/EditorSprites/arrow_left.png",typeof(Texture));
            arrows[2] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitMatch/Textures_png/EditorSprites/arrow_right.png",typeof(Texture));
            arrows[3] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitMatch/Textures_png/EditorSprites/arrow_up.png",typeof(Texture));
            arrows[4] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitMatch/Textures_png/EditorSprites/circle arrow.png",typeof(Texture));
            arrows[5] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitMatch/Textures_png/EditorSprites/circle arrows.png",typeof(Texture));

            teleports[0] =
                (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitMatch/Textures_png/EditorSprites/teleport_icon1.png",typeof(Texture));
            teleports[1] =(Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitMatch/Textures_png/EditorSprites/teleport_icon2.png",typeof(Texture));

            arrows_enter[0] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitMatch/Textures_png/EditorSprites/arrow_red.png",typeof(Texture));
            arrows_enter[1] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitMatch/Textures_png/EditorSprites/arrow_red_left.png",typeof(Texture));
            arrows_enter[2] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitMatch/Textures_png/EditorSprites/arrow_red_right.png",typeof(Texture));
            arrows_enter[3] = (Texture)AssetDatabase.LoadAssetAtPath("Assets/FruitMatch/Textures_png/EditorSprites/arrow_red_up.png",typeof(Texture));
...
//        }
        ...
        {
            GUILayout.Label("FruitMatch", EditorStyles.boldLabel,
                GUILayout.Width(400));
