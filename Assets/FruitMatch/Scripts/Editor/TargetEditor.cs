...
public class TargetEditor : EditorWindow
{
    ...
    [MenuItem("FruitMatch/Settings/Target editor")]
    ...
    void OnEnable()
    {
        targetObject = AssetDatabase.LoadAssetAtPath("Assets/FruitMatch/Resources/Levels/TargetEditorScriptable.asset", typeof(TargetEditorScriptable)) as TargetEditorScriptable;
...
//        GuiList.Show(targetObject.targets, () => {        Selection.activeObject = AssetDatabase.LoadMainAssetAtPath("Assets/SweetSugar/Resources/Levels/TargetEditorScriptable.asset");});
        ...
        if (GUILayout.Button("Update all level targets"))
        {
            ...
            {
                var targetsEditor = AssetDatabase.LoadAssetAtPath<TargetEditorScriptable>("Assets/FruitMatch/Resources/Levels/TargetEditorScriptable.asset");
    ...
    private TargetLevel OpenTarget(int levelNumber)
    {
        ...
        if (asset == null)
        {
            ...
            string assetPathAndName = AssetDatabase.GenerateUniqueAssetPath("Assets/FruitMatch/Resources/Levels/Targets/TargetLevel" + levelNumber + ".asset");
